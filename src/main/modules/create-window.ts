import type { WindowsOptions } from '@shared/types'
...
// 创建窗口
export function createWindow(options?: WindowsOptions): BrowserWindow {
  // 创建窗口实例
  // const win = new BrowserWindow(Object.assign(defaultOptions, options))
  ...
  win.on('ready-to-show', () => {
    console.log('ready-to-show, initShow:', options?.initShow)
